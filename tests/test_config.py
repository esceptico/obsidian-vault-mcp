...
class ConfigTests(unittest.TestCase):
    def test_settings_load_from_environment(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            env = {
                "HEADLESS_OBSIDIAN_MCP_VAULT_ROOT": tmp,
                "HEADLESS_OBSIDIAN_MCP_AUTH_TOKEN": "secret",
                "HEADLESS_OBSIDIAN_MCP_OPENAI_API_KEY": "openai-key",
                "HEADLESS_OBSIDIAN_MCP_OPENAI_BASE_URL": "https://openrouter.ai/api/v1",
                "HEADLESS_OBSIDIAN_MCP_EMBEDDING_MODEL": "text-embedding-3-large",
                "HEADLESS_OBSIDIAN_MCP_EMBEDDING_DIMENSIONS": "256",
            }
    ...
    def test_embedding_batch_size_must_be_positive(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            env = {
                "HEADLESS_OBSIDIAN_MCP_VAULT_ROOT": tmp,
                "HEADLESS_OBSIDIAN_MCP_EMBEDDING_BATCH_SIZE": "0",
            }
            with patch.dict(os.environ, env, clear=True):
